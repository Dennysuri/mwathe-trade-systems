...
export default function AutoDAI() {
  ...
  const handleRun = () => {
    ...
    setTimeout(() => {
      ...
      addLog(`Pattern detected on ${market}. Heavy clustering of 0, 1, 2.`)
    }, 1500)
    setTimeout(() => addLog('Decision: Execute "Over 2" with 94% confidence.'), 3000)
    setTimeout(() => addLog('Contract purchased. Zero consecutive loss protection active.'), 4500)
